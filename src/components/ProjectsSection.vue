<template>
  <section class="py-24 left-1/2 right-1/2 w-screen -translate-x-1/2 relative bg-gradient-to-b from-white via-slate-50 to-white overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-30 pointer-events-none" aria-hidden="true">
      <div class="absolute top-20 -right-32 w-96 h-96 bg-sky-200 rounded-full mix-blend-multiply filter blur-3xl animate-float"></div>
      <div class="absolute -bottom-20 -left-32 w-96 h-96 bg-amber-200 rounded-full mix-blend-multiply filter blur-3xl animate-float-delayed"></div>
      <div class="absolute top-1/2 left-1/2 w-80 h-80 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl animate-float-slow"></div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 relative">
      ...
      <div class="text-center mb-16">
        ...
        >
          ...
          <span class="text-xs uppercase tracking-wider text-slate-700 font-semibold">Portfolio</span>
        </div>
        ...
        >
          <div class="relative w-full h-56 md:h-64 lg:h-80 overflow-hidden">
            ...
            <img
              :src="p.image"
              :alt="p.title"
              class="w-full h-full object-cover object-center transform transition-transform duration-700 group-hover:scale-110 group-hover:rotate-2"
            />
            ...
            <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-75 group-hover:scale-100">
              <div class="bg-white/20 backdrop-blur-md border border-white/30 rounded-full px-6 py-3 flex items-center gap-2">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/60 to-transparent text-white transform transition-all duration-500 group-hover:translate-y-0">
              <h3 class="font-bold text-xl mb-2 group-hover:text-sky-400 transition-colors duration-300">
                {{ p.title }}
              </h3>
              ...
              <div class="flex items-center justify-between gap-3 mt-3">
                <span class="inline-flex items-center px-3 py-1.5 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white text-xs font-semibold uppercase tracking-wide">
                  {{ p.eventType }}
                </span>
                <span class="inline-flex items-center px-3 py-1.5 rounded-lg bg-sky-500/80 backdrop-blur-sm text-white text-xs font-medium">
                  {{ p.division }}
                </span>
              </div>
            </div>
            ...
            <!-- Top corner accent -->
            <div class="absolute top-4 right-4 w-12 h-12 rounded-full bg-gradient-to-br from-sky-500 to-amber-500 opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500"></div>
          </div>
      ...
      <div class="text-center" data-aos="fade-up" :data-aos-delay="projects.length * 100">
        ...
        <div class="mt-12 grid grid-cols-3 gap-8 max-w-3xl mx-auto" data-aos="fade-up" :data-aos-delay="projects.length * 100 + 200">
          <div class="text-center">
            <div class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-sky-600 to-amber-500 bg-clip-text text-transparent mb-2">
              150+
            </div>
