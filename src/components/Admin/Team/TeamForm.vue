<template>
  <div class="bg-gradient-to-br from-gray-50 to-white p-8 shadow-lg rounded-2xl mb-6 border border-gray-100">
    <h2 class="text-2xl font-bold mb-6 text-gray-800">Tambah Team Member</h2>
    ...
    <form @submit.prevent="submit">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="mb-3">
          ...
          <input 
            ...
            class="border-2 border-gray-200 p-3 w-full rounded-lg bg-gradient-to-br from-blue-50 to-white focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-all duration-200 text-gray-800 placeholder-gray-400" 
            required 
            placeholder="Contoh: CEO, Project Manager"
          />
        </div>
      </div>
      ...
      <button class="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-200">
        Save Team Member
      </button>
    </form>
  </div>
...
export default {
  ...
  setup(_, { emit }) {
    ...
    const submit = () => {
      ...
      // Reset form
      form.value = { name: "", position: "", bio: "", instagram: "", tiktok: "" }
      selectedFile.value = null
      photoPreview.value = null
    }

    return { form, handleFileChange, photoPreview, submit }
  },
}
</script>